		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Inbox",
									"targetURL": "#appinboxinbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appinboxinbox-display": {
								"semanticObject": "appinboxinbox",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.inbox.inbox",
									"url": sap.ui.require.toUrl("app/inbox/inbox")
								}
							}
						}
					}
